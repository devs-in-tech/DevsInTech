      ...
      <div className="grid md:grid-cols-2 my-10 lg:grid-cols-3 gap-6 max-w-xs md:max-w-full m-auto">
        ...
        <div class="max-w-sm border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          ...
          <div class="p-5">
            ...
            <p class="mb-5 font-medium text-gray-400 text-lg text-justify">Webinars are highly valuable resources for individuals interested in technology and software development. They are a valuable resource for individuals looking to enhance their technical skills.</p>
