          ...
          TeamData.map((data, index) => (
            <div key={index} className="p-4 md:w-72 w-72 sm:mb-0 mb-6">
              <div className="rounded-lg h-64 overflow-hidden">
                <img alt="content" className="object-cover object-center h-full w-full rounded-full border-8 border-[#AF7AF2]" src={data.img} />
              </div>
              <div className="relative bottom-10">
                ...
                <div className="bg-[#62DC67] p-3 rounded-b-2xl justify-center flex gap-3">
                  <Link href={data.GitHub} target="_blank">
                    <FaGithub size={24} className="hover:text-blue-700 transition-all transition-800"/>
                  </Link>
                  <Link href={data.LinkedIn} target="_blank">
                    <FaLinkedin size={24} className="hover:text-blue-700 transition-all transition-800"/>
                  </Link>
                  <Link href={data.Twitter} target="_blank">
                    <FaTwitter size={24} className="hover:text-blue-700 transition-all transition-800"/>
                  </Link>
                </div>
              </div>
            </div>
