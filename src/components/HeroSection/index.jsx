...
const HeroSection = () => {
  return (
    <div className="min-h-[calc(100vh-250px)] flex items-center bg-black mt-20">
      <div className="flex items-center justify-center text-center md:items-start md:text-left md:justify-start md:px-32 px-7">
