    ...
    <div className="min-h-[calc(100vh-115px)] flex items-center bg-black">
      <div className="flex items-center justify-center text-center md:items-start md:text-left md:justify-start px-7">
        <div className="flex flex-col items-center md:items-start gap-8 md:w-2/3 w-full">
          <h1 className="md:text-6xl sm:text-6xl text-4xl font-primary font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#AF7AF2] via-[#A5F7A8] to-[#AF7AF2]">
            Devs In Tech Community
          </h1>
          <p className="md:text-xl font-secondary sm:text-xl text-lg text-white sm:text-start text-justify">
