...
const HeroSection = () => {
  return (
    <div className="min-h-[calc(100vh-115px)] flex items-center bg-black dark:bg-white">
      <div className="flex items-center justify-center text-center md:items-start md:text-left md:justify-start px-7">
        <div className="flex flex-col items-center md:items-start gap-12 md:w-2/3 w-full ">
          ...
          <p className="md:text-2xl font-secondary sm:text-xl text-lg text-white sm:text-start text-justify dark:text-black">
